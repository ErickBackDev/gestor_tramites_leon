...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2023 a las 23:07:49
...
--
-- Base de datos: `gestor_leon`
--
CREATE DATABASE IF NOT EXISTS `gestor_leon` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `gestor_leon`;
...
CREATE TABLE `actas` (
  `id_acta` int(50) NOT NULL,
  `acta` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `actas` (`id_acta`, `acta`, `fecha`) VALUES
(1, 'Visa', '2023-05-03 02:06:40'),
(2, 'Matrimonio', '2023-05-03 02:06:46'),
(3, 'Defunción', '2023-05-03 02:06:57');
...
INSERT INTO `cargos` (`id_cargo`, `cargo`, `fecha`, `asignado`) VALUES
(1, 'Director', '2022-09-21 23:37:07', 1),
(2, 'Contador', '2022-09-21 23:37:18', 1),
(3, 'Invitado', '2022-09-21 23:37:26', 0),
(4, 'Técnico', '2023-05-03 02:12:13', 0);
...
INSERT INTO `carpetas` (`id_carpeta`, `id_cliente`, `papelera`, `fecha`) VALUES
(1, 1, 0, '2023-05-03 02:17:06'),
(2, 2, 0, '2023-05-03 02:18:12'),
(3, 3, 1, '2023-05-03 02:44:40');
...
CREATE TABLE `clientes` (
  ...
  `est_civil` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `sexo` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `paisNatal` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `estadoNatal` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `municipioNatal` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `parroquiaNatal` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `espNatal` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `codigoTel` varchar(5) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `telegram` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `likedIn` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `paisRes` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `estadoRes` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `municipioRes` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `parroquiaRes` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `direccion` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `n_actas` int(50) NOT NULL,
...
INSERT INTO `clientes` (`id_cliente`, `cedula`, `rif`, `p_nombre`, `s_nombre`, `p_apellido`, `s_apellido`, `f_nacimiento`, `est_civil`, `sexo`, `paisNatal`, `estadoNatal`, `municipioNatal`, `parroquiaNatal`, `espNatal`, `codigoTel`, `telefono`, `correo`, `facebook`, `instagram`, `telegram`, `likedIn`, `paisRes`, `estadoRes`, `municipioRes`, `parroquiaRes`, `direccion`, `n_actas`, `prioridad`, `fecha`, `historial`, `consolidado`, `descripcion`) VALUES
(1, 28078150, '28078150-5', 'Erickson', '', 'Graterol', '', '2001-07-23', 'Soltero', 'Masculino', 'Venezuela', '', '', '', '', '58', '4247212439', 'erickson17graterol@gmail.com', '', '', '', '', 'Venezuela', '', '', '', 'Valle Verde I', 2, 0, '2023-05-03 02:13:51', 0, 0, 'En trámite'),
(2, 28078563, '28078563-3', 'Emilio', '', 'Cabezas', '', '2001-10-21', 'Soltero', 'Masculino', 'Venezuela', '', '', '', '', '58', '4247000629', 'emiliodavidcc@gmail.com', '', '', '', '', 'Venezuela', '', '', '', 'Calle San Benito', 1, 1, '2023-05-03 02:15:57', 0, 0, 'En trámite'),
(3, 27776438, '27776438-8', 'Ronal', '', 'Garcia', '', '2001-06-02', 'Soltero', 'Masculino', 'Venezuela', '', '', '', '', '58', '4162152010', 'ronaljgd1@gmail.com', '', '', '', '', 'Venezuela', '', '', '', 'Bisnaca', 1, 1, '2023-05-03 02:34:31', 1, 1, 'Finalizado'),
(4, 28078347, '28078347-7', 'Barbara', '', 'Sarmiento', '', '2001-08-07', 'Soltero', 'Femenino', 'Venezuela', '', '', '', '', '58', '4122053558', 'barbysarmiento118@gmail.com', '', '', '', '', 'Venezuela', '', '', '', 'Calle Bolivar', 2, 0, '2023-05-03 02:44:10', 0, 0, 'En Trámite');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `clientes_actas`
--

CREATE TABLE `clientes_actas` (
  `id_cliente_acta` int(11) NOT NULL,
  `cedula_cliente` int(8) NOT NULL,
  `id_acta` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `clientes_actas`
--

INSERT INTO `clientes_actas` (`id_cliente_acta`, `cedula_cliente`, `id_acta`) VALUES
(1, 28078150, 2),
(2, 28078150, 1),
(3, 28078563, 3),
(4, 27776438, 2),
...
--
-- Estructura de tabla para la tabla `clientes_gastos`
--

CREATE TABLE `clientes_gastos` (
  `id_cliente_gasto` int(11) NOT NULL,
  `cedula_cliente` int(8) NOT NULL,
  `id_gasto` int(11) NOT NULL,
  `precio_dolar` varchar(20) COLLATE utf16_spanish_ci DEFAULT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf16 COLLATE=utf16_spanish_ci;

--
-- Volcado de datos para la tabla `clientes_gastos`
--

INSERT INTO `clientes_gastos` (`id_cliente_gasto`, `cedula_cliente`, `id_gasto`, `precio_dolar`, `fecha`) VALUES
(1, 27776438, 2, '50', '2023-05-03 02:48:52'),
(2, 28078563, 2, '50', '2023-05-09 13:12:24');
...
CREATE TABLE `empleados` (
  ...
  `exProfesional` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `exLaboral` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `id_cargo` int(11) NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `empleados` (`id_empleado`, `cedula`, `rif`, `p_nombre`, `s_nombre`, `p_apellido`, `s_apellido`, `f_nacimiento`, `est_civil`, `sexo`, `paisNatal`, `estadoNatal`, `municipioNatal`, `parroquiaNatal`, `espNatal`, `codigoTel`, `telefono`, `correo`, `paisRes`, `estadoRes`, `municipioRes`, `parroquiaRes`, `direccion`, `profesion`, `exProfesional`, `exLaboral`, `id_cargo`, `fecha`) VALUES
(1, 28078150, '28078150-5', 'Erickson', '', 'Graterol', '', '2001-07-23', 'Soltero', 'Masculino', 'Venezuela', '', '', '', '', '58', '4247212439', 'erickson17graterol@gmail.com', 'Venezuela', '', '', '', 'Valle Verde I', 'Ingeniero en Informatica', 'Ingeniero', 'Técnico, Vigilante', 1, '2023-05-03 02:09:12'),
(2, 28078563, '28078563-3', 'Emilio', '', 'Cabezas', '', '2001-10-21', 'Soltero', 'Masculino', 'Venezuela', '', '', '', '', '58', '4247000629', 'emiliodavidcc@gmail.com', 'Venezuela', '', '', '', 'Calle San Benito', 'Ingeniero', 'Programador', 'Ninguna', 2, '2023-05-03 02:10:49');
...
INSERT INTO `estados` (`id_estado`, `estado`, `id_pais`, `iso_3166-2`) VALUES
(1, 'Amazonas', 242, 'VE-X'),
(2, 'Anzoátegui', 242, 'VE-B'),
(3, 'Apure', 242, 'VE-C'),
(4, 'Aragua', 242, 'VE-D'),
(5, 'Barinas', 242, 'VE-E'),
(6, 'Bolívar', 242, 'VE-F'),
...
(14, 'Miranda', 242, 'VE-M'),
(15, 'Monagas', 242, 'VE-N'),
(16, 'Nueva Esparta', 242, 'VE-O'),
(17, 'Portuguesa', 242, 'VE-P'),
(18, 'Sucre', 242, 'VE-R'),
(19, 'Táchira', 242, 'VE-S'),
(20, 'Trujillo', 242, 'VE-T'),
(21, 'La Guaira', 242, 'VE-W'),
(22, 'Yaracuy', 242, 'VE-U'),
(23, 'Zulia', 242, 'VE-V'),
(24, 'Distrito Capital', 242, 'VE-A');
...
CREATE TABLE `gastos` (
  `id_gasto` int(11) NOT NULL,
  `gasto` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `precio_dolar` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `gastos` (`id_gasto`, `gasto`, `precio_dolar`, `fecha`) VALUES
(1, 'Aranceles', '100', '2022-09-21 05:02:33'),
(2, 'Viáticos', '50', '2023-05-03 02:46:33');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `id_cargo`, `correo`, `usuario`, `password`, `fecha`) VALUES
(2, 'Erickson', 'Graterol', 1, 'erickson17graterol@gmail.com', 'admin', '7c222fb2927d828af22f592134e8932480637c0d', '2023-05-03 02:01:35'),
(4, 'Barbara', 'Sarmiento', 3, 'barbysarmiento118@gmail.com', 'barby', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '2023-05-03 02:04:36'),
(3, 'Emilio', 'Cabezas', 2, 'emiliodavidcc@gmail.com', 'emilio', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '2023-05-03 02:02:52'),
(5, 'Ronal', 'Garcia', 3, 'ronaljgd@gmail.com', 'ronal', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '2023-05-03 02:05:12');
...
ALTER TABLE `carpetas`
  ...
  ADD KEY `carpetas_usuarios` (`id_cliente`);
...
--
-- Indices de la tabla `clientes_actas`
--
ALTER TABLE `clientes_actas`
  ADD PRIMARY KEY (`id_cliente_acta`),
  ADD KEY `actas_clientes` (`id_acta`),
  ADD KEY `clientes_actas` (`cedula_cliente`);

--
-- Indices de la tabla `clientes_gastos`
--
ALTER TABLE `clientes_gastos`
  ADD PRIMARY KEY (`id_cliente_gasto`),
  ADD KEY `gastos_clientes` (`cedula_cliente`),
  ADD KEY `clientes_gastos` (`id_gasto`);
...
ALTER TABLE `empleados`
  ...
  ADD UNIQUE KEY `rif` (`rif`),
  ADD KEY `empleados_cargos` (`id_cargo`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `usuarios_cargos` (`id_cargo`);
...
--
ALTER TABLE `actas`
  MODIFY `id_acta` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `carpetas`
  MODIFY `id_carpeta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `clientes_actas`
--
ALTER TABLE `clientes_actas`
  MODIFY `id_cliente_acta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `clientes_gastos`
--
ALTER TABLE `clientes_gastos`
  MODIFY `id_cliente_gasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `carpetas`
  ADD CONSTRAINT `carpetas_clientes` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `clientes_actas`
--
ALTER TABLE `clientes_actas`
  ADD CONSTRAINT `actas_clientes` FOREIGN KEY (`id_acta`) REFERENCES `actas` (`id_acta`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `clientes_actas` FOREIGN KEY (`cedula_cliente`) REFERENCES `clientes` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `clientes_gastos`
--
ALTER TABLE `clientes_gastos`
  ADD CONSTRAINT `clientes_gastos` FOREIGN KEY (`id_gasto`) REFERENCES `gastos` (`id_gasto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `gastos_clientes` FOREIGN KEY (`cedula_cliente`) REFERENCES `clientes` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `empleados_cargos` FOREIGN KEY (`id_cargo`) REFERENCES `cargos` (`id_cargo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `estados`
--
ALTER TABLE `estados`
  ADD CONSTRAINT `estado_pais` FOREIGN KEY (`id_pais`) REFERENCES `paises` (`id_pais`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_cargos` FOREIGN KEY (`id_cargo`) REFERENCES `cargos` (`id_cargo`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
