            ...
            if (data == 1){
                ...
                Swal.fire({
                    ...
                    if (result.value){
                        ...
                        document.getElementById('frmModificarPerfil').style.display = 'block';
                    }
                })
            } else {
                $('#frmValidarUser')[0].reset();
            ...
            if (data == 1){
                ...
                Swal.fire({
                    ...
                    if (result.value){
                        ...
                        document.getElementById('frmValidarOtroUser').style.display = 'none';
                        document.getElementById('textoOtroModificar').style.display = 'block';
                        document.getElementById('ModificarOtrosPerfiles').style.display = 'block';
                    }
                })
            } else {
                $('#frmValidarUser')[0].reset();
