...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2022 a las 05:26:31
...
(1, 'Director', '2022-09-21 23:37:07', 0),
(2, 'Contador', '2022-09-21 23:37:18', 0),
...
--
ALTER TABLE `actas`
  MODIFY `id_acta` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `clientes_actas`
  MODIFY `id_cliente_acta` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `clientes_gastos`
--
ALTER TABLE `clientes_gastos`
  MODIFY `id_cliente_gasto` int(11) NOT NULL AUTO_INCREMENT;
