<?php 
	...
	$profesion = (isset($_POST['profesionEdit'])) ? $_POST['profesionEdit'] : "";
	$exProfesional = (isset($_POST['exProfesionalEdit'])) ? $_POST['exProfesionalEdit'] : "";
	$exLaboral = (isset($_POST['exLaboralEdit'])) ? $_POST['exLaboralEdit'] : "";
	$idCargo = (isset($_POST['cargoEmpleado'])) ? $_POST['cargoEmpleado'] : "";
	$cargo = (isset($_POST['empleadosCargos'])) ? $_POST['empleadosCargos'] : "";

	if ($cargo != $idCargo) {
		if ($cargo==1) {
			$query2 = mysqli_query($conectar, "SELECT id_empleado FROM empleados WHERE id_cargo = 1");
			$nr2 = mysqli_num_rows($query2);

			if($nr2==1){
				$data = 2;
			}else{
				$sql = "UPDATE empleados SET rif='$rif', p_nombre='$p_nombre', s_nombre='$s_nombre', p_apellido='$p_apellido', s_apellido='$s_apellido', f_nacimiento='$f_nacimiento', est_civil='$est_civil', sexo='$sexo', paisNatal='$paisNatal', estadoNatal='$estadoNatal', municipioNatal='$municipioNatal', parroquiaNatal='$parroquiaNatal', espNatal='$espNatal', codigoTel='$codigoTel', telefono='$telefono', correo='$correo', paisRes='$paisRes', estadoRes='$estadoRes', municipioRes='$municipioRes', parroquiaRes='$parroquiaRes', direccion='$direccion', profesion='$profesion', exProfesional='$exProfesional', exLaboral='$exLaboral', id_cargo='$cargo' WHERE cedula = '$cedula'";
			...
			if ($cargo==2) {
				$query3 = mysqli_query($conectar, "SELECT id_empleado FROM empleados WHERE id_cargo = 2");
