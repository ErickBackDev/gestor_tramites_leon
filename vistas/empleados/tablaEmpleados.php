<?php
	...
	$sql = "SELECT * FROM empleados INNER JOIN cargos ON cargos.id_cargo = empleados.id_cargo";
...
<div class="table-responsive">
	<table class="table table-striped table-hover table-primary" id="tablaEmpleadosDataTable">
		...
		<?php 
		 ...
		 ?>
			<tr>
				<td class="col-sm-1">
					<a class="btn btn-link" title="Información" onclick="infoEmpleado('<?php echo $row['cedula']; ?>')" data-toggle="modal" data-target="#modalInfoEmpleados">
				...
				<td class="col-sm-2" style="text-align: center;">
					<?php if ($idCargoUser == 1 or $idCargoUser == 2) { ?>
						<span class="btn btn-warning bt-sm" title="Editar" onclick="editarEmpleado('<?php echo $row['cedula']; ?>'); modalEditEmpleados();" data-toggle="modal" data-target="#modalModificarEmpleados">
							<span class="fa-solid fa-user-pen"></span>
						</span>
						<span class="btn btn-danger bt-sm" title="Eliminar" onclick="eliminarEmpleado('<?php echo $row['cedula']; ?>')">
