<?php
	...
	$sql = "SELECT * FROM clientes WHERE historial != 0 AND consolidado != 0";
...
<div class="table-responsive">
	<table class="table table-striped table-hover table-primary" id="tablaClientesConsolidadosDataTable">
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tablaClientesConsolidadosDataTable').DataTable({
			responsive: "true",
			dom: 'Bfrtilp',
			buttons: {
				dom: {
